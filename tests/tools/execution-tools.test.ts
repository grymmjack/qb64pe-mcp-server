...
describe("Execution Tools", () => {
  ...
  beforeEach(() => {
    ...
    mockExecutionService = {
      ...
      getRealTimeMonitoringGuidance: jest.fn(),
  ...
  describe("registerExecutionTools", () => {
    ...
    it("should register all expected tool names", () => {
      registerExecutionTools(mockServer, services);
      const toolNames = (mockServer.registerTool as jest.Mock).mock.calls.map(
        (call) => call[0],
      );
  ...
  describe("analyze_qb64pe_execution_mode", () => {
    it("should analyze execution mode successfully", async () => {
      ...
      expect(mockExecutionService.getExecutionGuidance).toHaveBeenCalledWith(
        mockExecutionState,
      );
    ...
    it("should handle analysis errors", async () => {
      ...
      mockExecutionService.analyzeExecutionMode.mockImplementation(() => {
        throw error;
      });

      await handler!({ sourceCode: "test" });

      expect(createMCPError).toHaveBeenCalledWith(
        error,
  ...
  describe("get_process_monitoring_commands", () => {
    it("should get monitoring commands successfully", async () => {
      ...
      mockExecutionService.getProcessMonitoringCommands.mockReturnValue(
        mockMonitoringCommands,
      );
      mockExecutionService.getProcessTerminationCommands.mockReturnValue(
        mockTerminationCommands,
      );

      await handler!({ processName: "qb64pe", platform: "linux" });

      expect(
        mockExecutionService.getProcessMonitoringCommands,
      ).toHaveBeenCalledWith("qb64pe");
      expect(createMCPResponse).toHaveBeenCalled();
    });
    ...
    it("should handle command generation errors", async () => {
      ...
      mockExecutionService.getProcessMonitoringCommands.mockImplementation(
        () => {
          throw error;
        },
      );
      ...
      expect(createMCPError).toHaveBeenCalledWith(
        error,
        "getting process monitoring commands",
      );
    });
  });
  ...
  describe("generate_monitoring_template", () => {
    ...
    it("should handle template generation errors", async () => {
      ...
      mockExecutionService.generateMonitoringTemplate.mockImplementation(() => {
        throw error;
      });
  ...
  describe("generate_console_formatting_template", () => {
    it("should generate console template successfully", async () => {
      ...
      mockExecutionService.generateConsoleFormattingTemplate.mockReturnValue(
        mockTemplate,
      );
      ...
      expect(
        mockExecutionService.generateConsoleFormattingTemplate,
      ).toHaveBeenCalledWith("structured");
      expect(createMCPResponse).toHaveBeenCalledWith({
        template: mockTemplate,
      });
    });
    ...
    it("should handle console template errors", async () => {
      ...
      mockExecutionService.generateConsoleFormattingTemplate.mockImplementation(
        () => {
          throw error;
        },
      );
      ...
      expect(createMCPError).toHaveBeenCalledWith(
        error,
        "generating console formatting template",
      );
    });
  });
  ...
  describe("get_execution_monitoring_guidance", () => {
    it("should get monitoring guidance successfully", async () => {
      ...
      mockExecutionService.getRealTimeMonitoringGuidance.mockReturnValue(
        mockGuidance,
      );
      ...
      expect(
        mockExecutionService.getRealTimeMonitoringGuidance,
      ).toHaveBeenCalled();
      expect(createMCPResponse).toHaveBeenCalledWith({
    ...
    it("should handle guidance errors", async () => {
      ...
      mockExecutionService.getRealTimeMonitoringGuidance.mockImplementation(
        () => {
          throw error;
        },
      );
      ...
      expect(createMCPError).toHaveBeenCalledWith(
        error,
        "getting execution monitoring guidance",
      );
    });
  });
  ...
  describe("parse_console_output", () => {
    it("should parse console output successfully", async () => {
      ...
      expect(mockExecutionService.parseConsoleOutput).toHaveBeenCalledWith(
        "test output",
      );
    ...
    it("should handle parsing errors", async () => {
      ...
      mockExecutionService.parseConsoleOutput.mockImplementation(() => {
        throw error;
      });
  ...
  describe("get_file_monitoring_commands", () => {
    it("should get file monitoring commands successfully", async () => {
      ...
      mockExecutionService.getFileMonitoringCommands.mockReturnValue(
        mockCommands,
      );
      ...
      expect(
        mockExecutionService.getFileMonitoringCommands,
    ...
    it("should handle file monitoring errors", async () => {
      ...
      mockExecutionService.getFileMonitoringCommands.mockImplementation(() => {
        throw error;
      });
      ...
      expect(createMCPError).toHaveBeenCalledWith(
        error,
        "getting file monitoring commands",
      );
    });
  });
});
